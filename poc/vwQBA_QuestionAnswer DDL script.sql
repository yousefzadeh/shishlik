/****** Object:  View [reporting].[vwQBA_QuestionAnswer]    Script Date: 16/12/2025 11:25:19 AM ******/
SET ANSI_NULLS ON
GO
...
create view [reporting].[vwQBA_QuestionAnswer] as
    ...
    a_raw as (
        select
            ...
            ReviewerComment
        from "sqldb-6clicks-staging"."dbo"."Answer" a
    ...
    q_raw as (  -- dbo.Question with casting
        ...
        from "sqldb-6clicks-staging"."dbo"."Question" q
        where IsDeleted = 0
    ),
   ...
   ,qa_multi_json as (
    ...
    QuestionGroup as   (
        ...
        from "sqldb-6clicks-staging"."dbo"."QuestionGroup" --system generated fields for if a record is deleted
WHERE IsDeleted = 0
    ),
    QuestionGroupResponse as   (
        ...
        from "sqldb-6clicks-staging"."dbo"."QuestionGroupResponse" --system generated fields for if a record is deleted
WHERE IsDeleted = 0
    ),
    qa_group_single as (
        select 
