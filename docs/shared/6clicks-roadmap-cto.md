...
- Limited incremental processing (full refreshes)
...
- More moving parts (CDC \+ Delta \+ Databricks)  
- Data duplication (from operational DB to Data Warehouse)
...
- [ ] Implement end-to-end  
      - Include Enabling CDC on the required source tables  
