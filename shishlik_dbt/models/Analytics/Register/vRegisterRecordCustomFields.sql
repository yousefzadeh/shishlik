--change issue to register record
...
from {{ source("register_ref_models", "IssueCustomAttributeData") }} icad
...
NULL CustomFielddateValue
from {{ source("register_ref_models", "IssueFreeTextControlData") }} ic
join {{ source("third-party_ref_models", "ThirdPartyControl") }} tpc
...
select 
TenantId,
IssueId RegisterRecord_Id,
CustomField RegisterRecord_CustomField,
CustomFieldValue RegisterRecord_CustomFieldValue,
CustomFielddateValue RegisterRecord_CustomFieldDateValue
from final