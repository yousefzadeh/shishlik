...
from {{ source("asset_ref_models", "IssueCustomAttributeData") }} icad
...
NULL CustomFielddateValue
from {{ source("asset_ref_models", "IssueFreeTextControlData") }} ic
join {{ source("third-party_ref_models", "ThirdPartyControl") }} tpc
...
TenantId,
IssueId Asset_Id,
CustomField Asset_CustomField,
CustomFieldValue Asset_CustomFieldValue,
CustomFielddateValue Asset_CustomFieldDateValue
from final