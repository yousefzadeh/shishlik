...
select
    ...
    {{ col_rename("QuestionGroupResponseId", "Question") }},
    ...
    {{ col_rename("IsDeleted", "Question") }},

    {{ col_rename("PK", "Question") }},
    {{ col_rename("UpdateTime", "Question") }},--date column addition for synapse incremental load
    {{ col_rename("IsActive", "Question") }}
from base
