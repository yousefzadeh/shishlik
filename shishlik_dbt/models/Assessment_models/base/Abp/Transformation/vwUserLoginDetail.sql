with
    base1 as (
        ...
        where
            c.EntityTypeFullName = 'LegalRegTech.Authorization.Users.User' and pc.PropertyNameVarChar = 'LastLoginTime'
    ),
    base2 as (
        select
            cs.TenantId Tenant_Id,
            c.EntityId,
            au.Id UserId,
            au.EmailAddress ActionedEmailAddress,
...
select distinct
    ...
    base1.Event,
    base2.UserId,
    base2.ActionedEmailAddress,
    base2.Actioned_by,
    base2.Impacted + ' logged in' Changed,
    base2.Impacted
