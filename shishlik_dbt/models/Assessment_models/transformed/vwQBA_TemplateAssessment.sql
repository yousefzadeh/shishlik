{# 
DOC START
  - name: vwQBA_TemplateAssessment
    description: |
      One row for each Question Based Assessments (QBA) Template and Assessment.
    columns:
      - name: Template_Id
...
with final as (
    ...
    *
    ...
    where Assessment_WorkFlowId = 0 -- Question Based Assessments Only 
)
select 
Template_Id,
Template_Name,
