...
with final as (
    ...
    a2.Authority_Name TargetAuthority_Name,
    ...
    left join {{ ref("vwTenantAuthorityProvisionMapping") }} tapm on tapm.TenantAuthorityProvisionMapping_SourceAuthorityProvisionId = ap.AuthorityProvision_Id
        and tapm.TenantAuthorityProvisionMapping_TenantId = ap.Tenant_Id
    left join {{ ref("vwAuthorityProvision") }} ap2 on ap2.AuthorityProvision_Id = tapm.TenantAuthorityProvisionMapping_TargetAuthorityProvisionId
    left join {{ ref("vwAuthority") }} a2 on a2.Authority_Id = ap2.AuthorityProvision_AuthorityId 
...
from final
{# 
all tenants, all workflows 659 rows
where Tenant_Id = 1384
and Assessment_WorkFlowId = 0 -- RBA 13 rows, QBA 42 rows 
#}