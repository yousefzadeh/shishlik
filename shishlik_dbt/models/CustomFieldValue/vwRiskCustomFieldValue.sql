...
with 
{#- 
    Risk to Custom Field Values assignments
    - Risk to Custom Field Values assignments for selection from options  
    - Risk to Custom Field Values assignments for user defined values
#}
entity_custom_selected as (
	-- Risk
    select 
    RiskCustomAttributeData_TenantId Tenant_Id,
	RiskCustomAttributeData_RiskId Entity_Id, 
...
entity_custom_user_defined as (
	...
	RiskThirdPartyControlCustomText_RiskId Entity_Id, 
